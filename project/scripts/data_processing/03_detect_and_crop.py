...
META_FILE = "data/processed/faces_meta.json"
TARGET_SIZE = 512
PADDING = 0.4
...
print("Loading YOLOv8 anime face model...")
...
if __name__ == "__main__":
    ...
    print(f"\nSaving metadata to {META_FILE}...")
    with open(META_FILE, 'w', encoding='utf-8') as f:
        json.dump(all_faces, f, indent=2, ensure_ascii=False)

    print(f"Done. Detected {len(all_faces)} faces, missed {no_face_count} images.")
